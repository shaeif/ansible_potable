...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '-Wno-unused-command-line-argument -flto '
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIGURE_LDFLAGS_NODIST': '-L/home/shaeif/workspace/portable-python/build/deps/lib '
                             '-Wl,-z,origin '
                             f'-Wl,-rpath={prefix}/lib:{prefix}/lib64 '
                             '-flto -fuse-linker-plugin -ffat-lto-objects '
                             '-flto-partition=none -g',
 'CONFIG_ARGS': "f'--prefix={prefix}' '--enable-optimizations' "
                "'--with-lto' '--with-ensurepip=upgrade' '--with-system-ffi' "
                "'--with-dbmliborder=gdbm:bdb:ndbm'",
 'CONFINCLUDEDIR': f'{prefix}/include',
 'CONFINCLUDEPY': f'{prefix}/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/shaeif/workspace/portable-python/build/components/cpython/coverage.info',
 'COVERAGE_REPORT': '/home/shaeif/workspace/portable-python/build/components/cpython/lcov-report',
 ...
 'LIBPL': f'{prefix}/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             '-fwrapv -O3 -Wall '
                             '-Wno-unused-command-line-argument -flto '
                             '-fuse-linker-plugin -ffat-lto-objects '
                             '-flto-partition=none -g -std=c99 -Wextra '
                             '-Wno-unused-result -Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden '
                             '-Wno-unused-command-line-argument -fprofile-use '
 ...
 'PY_CFLAGS_NODIST': '-Wno-unused-command-line-argument -flto '
                     '-fuse-linker-plugin -ffat-lto-objects '
                     '-flto-partition=none -g -std=c99 -Wextra '
                     '-Wno-unused-result -Wno-unused-parameter '
                     '-Wno-missing-field-initializers '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -Wno-unused-command-line-argument -flto '
                   ...
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/home/shaeif/workspace/portable-python/build/deps/lib '
                    '-Wl,-z,origin '
                    f'-Wl,-rpath={prefix}/lib:{prefix}/lib64 '
                    '-flto -fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g '
                    '-L/home/shaeif/workspace/portable-python/build/deps/lib '
                    '-Wl,-z,origin '
                    f'-Wl,-rpath={prefix}/lib:{prefix}/lib64',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '',
 'PY_LDFLAGS_NODIST': '-L/home/shaeif/workspace/portable-python/build/deps/lib '
                      '-Wl,-z,origin '
                      f'-Wl,-rpath={prefix}/lib:{prefix}/lib64 '
                      '-flto -fuse-linker-plugin -ffat-lto-objects '
                      '-flto-partition=none -g '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -Wno-unused-command-line-argument -flto '
                        '-fuse-linker-plugin -ffat-lto-objects '
                        '-flto-partition=none -g -std=c99 -Wextra '
                        '-Wno-unused-result -Wno-unused-parameter '
                        '-Wno-missing-field-initializers '
 ...
 'abs_builddir': '/home/shaeif/workspace/portable-python/build/components/cpython',
 'abs_srcdir': '/home/shaeif/workspace/portable-python/build/components/cpython',
